...
template <typename I> inline ALG2_CXX14_CONSTEXPR I& Rational<I>::numerator()
{
  return num;
}
...
template <typename I> inline ALG2_CXX14_CONSTEXPR I& Rational<I>::denominator()
{
  return den;
}
...
{
  return Rational<I>(num/Util::gcd<I>(num, den), den/Util::gcd<I>(num, den));
}
template <typename I> inline ALG2_CXX14_CONSTEXPR Rational<I> Rational<I>::reduced()
{
  I i = Util::gcd<I>(num, den); return Rational(num /= i, den /= i);
}
